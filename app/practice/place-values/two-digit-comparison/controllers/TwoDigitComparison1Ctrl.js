angular.module('simpleMath').controller("TwoDigitComparison1Ctrl", function ($scope, $location) {
  ...
  $scope.nextQuestion = () => {
    $location.url('practice/place-values/two-digit-comparison/two-digit-comparison-2');
  };
});