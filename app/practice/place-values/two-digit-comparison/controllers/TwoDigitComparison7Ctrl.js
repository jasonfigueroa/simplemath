angular.module('simpleMath').controller("TwoDigitComparison7Ctrl", function ($scope, $location) {
  
  $scope.userAnswer = '';
  const answer = 'less than';
  ...
  $scope.nextQuestion = () => {
    $location.url('practice/place-values/two-digit-comparison/two-digit-comparison-8');
  };
});