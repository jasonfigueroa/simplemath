angular.module('simpleMath').controller("TwoDigitPlaceValue5Ctrl", function ($scope, $location) {
  ...
  $scope.nextQuestion = () => {
    $location.url('practice/place-values/two-digit-place-value/two-digit-place-value-6');
  };
});