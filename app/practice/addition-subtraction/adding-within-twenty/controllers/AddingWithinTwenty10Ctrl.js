app.controller("AddingWithinTwenty10Ctrl", function ($scope, $location) {
  ...
  $scope.nextQuestion = () => {
    $location.url('/practice/addition-subtraction/adding-within-twenty/adding-within-twenty-complete');
  };
});