app.controller("SubtractWithinTwenty4Ctrl", function ($scope, $location) {
  $scope.msg = '';
  ...
  $scope.nextQuestion = () => {
    $location.url('/practice/addition-subtraction/subtract-within-twenty/subtract-within-twenty-5');
  };
});